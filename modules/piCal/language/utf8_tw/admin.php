...
define('_AM_MYBLOCKSADMIN','piCal的 區塊與群組管理');
...
define('_AM_FMT_SERVER_TZ_ALL','本伺服器的冬季時區： %+2.1f<br />本伺服器的夏季時區： %+2.1f<br />伺服器時區設定定義： %s (此處伺服器預設語系跟您網站預設語系衝突會產生亂碼，不用在意)<br />本XOOPS裡伺服器所在地預設的設定值： %+2.1f<br />行事曆piCal採用值： %+2.1f<br />');
...
define('_AM_NOTICE_SERVER_TZ','如果您的伺服器架設於日光節約時區 (Day Light Saving) 將造成 piCal 0.8以前所登記的資料出現一個小時左右的誤差，如有那種情形請勿按此按鈕。');
