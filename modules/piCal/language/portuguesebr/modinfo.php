...
define("_MI_PICAL_DESC","M…Åulo de calendáÓio com agenda.");

// Names of blocks for this module (Not all module has blocks)
define("_MI_PICAL_BNAME_MINICAL","Mini-calendáÓio");
define("_MI_PICAL_BNAME_MINICAL_DESC","Mostra um mini-calendáÓio em bloco.");
define("_MI_PICAL_BNAME_MONTHCAL","CalendáÓio mensal em tamanho completo");
define("_MI_PICAL_BNAME_MONTHCAL_DESC","Mostra um calendáÓio mensal em tamanho completo.");
...
define("_MI_PICAL_BNAME_THEDAYS_DESC","Mostra eventos do dia indicado no calendáÓio.");
define("_MI_PICAL_BNAME_COMING","Pr…Ùimos eventos");
define("_MI_PICAL_BNAME_COMING_DESC","Mostra os pr…Ùimos eventos.");
define("_MI_PICAL_BNAME_AFTER","Eventos depois %s");
define("_MI_PICAL_BNAME_AFTER_DESC","Mostra os eventos ap…Ô o dia indicado no calendáÓio.");
...
define("_MI_PICAL_ADMENU1","Administraîåo de eventos");
define("_MI_PICAL_ADMENU_CAT","Administraîåo de categorias");
define("_MI_PICAL_ADMENU_CAT2GROUP","Permiss‰Æs globais das categorias");
define("_MI_PICAL_ADMENU2","Permis‰Æs globais dos grupos");
...
define('_MI_PICAL_GLOBAL_NOTIFYDSC', 'Opî÷es globais de aviso do piCal.');
define('_MI_PICAL_CATEGORY_NOTIFY', 'Categoria');
define('_MI_PICAL_CATEGORY_NOTIFYDSC', 'Opî÷es de aviso que se aplicam para a categoria atual.');
define('_MI_PICAL_EVENT_NOTIFY', 'Evento');
define('_MI_PICAL_EVENT_NOTIFYDSC', 'Opî÷es de aviso que se aplicam para o evento atual.');
...
define('_MI_PICAL_GLOBAL_NEWEVENT_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} aviso automáÕico: Novo evento');
...
define('_MI_PICAL_CATEGORY_NEWEVENT_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} aviso automáÕico: Novo evento em {CATEGORY_TITLE}');
