...
define('_MB_PICAL_PLUGINS','Active Plugins');
...
define('_MB_PICAL_PREV_MONTH','Anterior');
define('_MB_PICAL_NEXT_MONTH','Seguinte');
define('_MB_PICAL_YEAR','');
define('_MB_PICAL_MONTH','');
define('_MB_PICAL_JUMP','Pular');
...
// %s means the indicated day
define('_MB_PICAL_EVENTS_THEDAY','Eventos de %s');
